...
| API | 版 | パスプレフィックス | 仕様書 | OpenAPI 定義 | Web リファレンス |
|---|---|---|---|---|---|
| **EMS OpenAPI v2** ⭐推奨 | 2.2 | `/v2/ems/{id}/` | [説明書](docs/ems-openapi-v2.md)<br>[サンプル集](docs/ems-openapi-v2-samples.md) | [OpenAPI YAML](openapi/ems-openapi-v2.yaml) | [📘 API リファレンス](https://enapir.github.io/enecloud-api-spec/ems-v2.html) |
| **VPP API v1** ⭐推奨 | 1.4 | `/v1/vpp/{vpp_id}/` | [説明書](docs/vpp-api-v1.md)<br>[サンプル集](docs/vpp-api-v1-samples.md) | [OpenAPI YAML](openapi/vpp-openapi-v1.yaml) | [📘 API リファレンス](https://enapir.github.io/enecloud-api-spec/vpp-v1.html) |
| EMS OpenAPI v1（旧版・既存互換） | 1.13 | `/v1/ems/{id}/` | [説明書](docs/ems-openapi-v1.md) | [OpenAPI YAML](openapi/ems-openapi-v1.yaml) | [📘 API リファレンス](https://enapir.github.io/enecloud-api-spec/ems-v1.html) |
